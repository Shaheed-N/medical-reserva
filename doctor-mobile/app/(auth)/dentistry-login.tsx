...
export default function DentistryLogin() {
    ...
    return (
        <ScrollView contentContainerStyle={[styles.container, { backgroundColor: theme.background }]}>
            ...
            <View style={styles.header}>
                ...
                <Text style={[styles.title, { color: theme.text }]}>Dental Portal</Text>
                <Text style={[styles.subtitle, { color: theme.textSecondary }]}>Dentistry & orthodontic management</Text>
            </View>
            <View style={styles.form}>
                <TextInput
                    style={[styles.input, { backgroundColor: theme.surface, borderColor: theme.border, color: theme.text }]}
                    placeholder="Dental ID / Email"
                    value={email}
                ...
                />
                <TouchableOpacity style={[styles.btn, { backgroundColor: '#3B82F6' }]} onPress={handleLogin}>
                    <Text style={styles.btnText}>Open Clinic</Text>
                </TouchableOpacity>
            </View>
        </ScrollView>
    );
