        ...
        <div className="min-h-screen grid grid-cols-1 lg:grid-cols-2 bg-white font-sans">
            ...
            <div className="flex flex-col justify-center px-4 py-12 lg:px-24 bg-white border-r border-gray-100">
                <div className="w-full max-w-md mx-auto">
                    <div className="mb-12">
                        <div className="w-12 h-12 bg-[#0F766E] flex items-center justify-center text-white mb-6 rounded-sm shadow-md">
                    ...
                    <div className="bg-slate-50 p-8 border border-slate-200 rounded-sm">
                        {step === 'PHONE' ? (
                            <form onSubmit={handleSendOtp} className="space-y-6">
                                <div>
                                    ...
                                    <div className="flex">
                                        <span className="inline-flex items-center px-4 border border-r-0 border-slate-300 bg-slate-100 text-slate-600 text-sm font-bold font-mono">
                                            +994
                                        </span>
                                        <input
                                            id="phone"
                                            ...
                                            className="block w-full border border-slate-300 px-4 py-3 text-gray-900 focus:ring-1 focus:ring-[#0F766E] focus:border-[#0F766E] placeholder:text-gray-400 sm:text-sm font-mono"
                                            value={phoneNumber}
                                ...
                                <button
                                    type="submit"
                                    className="w-full flex justify-center py-3.5 px-4 border border-transparent text-sm font-bold text-white bg-[#0F766E] hover:bg-[#134E4A] focus:outline-none transition-colors uppercase tracking-widest shadow-sm"
                                >
                            ...
                            <form onSubmit={handleVerifyOtp} className="space-y-6">
                                <div>
                                    <button
                                        ...
                                        className="text-xs text-[#0F766E] font-bold mb-4 flex items-center gap-1 hover:underline uppercase tracking-wide"
                                    >
                                        Change Number
                                    </button>
                                    ...
                                    <input
                                        ...
                                        maxLength={4}
                                        placeholder="0000"
                                        className="block w-full border border-slate-300 px-4 py-3 text-gray-900 text-center text-xl tracking-[0.5em] font-mono focus:ring-1 focus:ring-[#0F766E] focus:border-[#0F766E]"
                                        value={otp}
                        ...
                        <div className="mt-6 pt-6 border-t border-slate-200">
                            <p className="text-xs text-center text-slate-400 font-medium">
                                Secure Connection • 256-bit Encryption • Republic of Azerbaijan
                            </p>
                        </div>
                    </div>
