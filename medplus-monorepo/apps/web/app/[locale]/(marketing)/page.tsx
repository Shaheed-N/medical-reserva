    ...
    <div className="min-h-screen bg-white font-sans text-slate-900">
      ...
      <section className="relative min-h-[90vh] flex items-center overflow-hidden bg-[#0F172A]">
        ...
        <div className="absolute inset-0 z-0">
          ...
          <img
            src="https://images.unsplash.com/photo-1516549655169-df83a092fc5b?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80"
        ...
        <div className="container mx-auto px-6 relative z-20 pt-20">
          <div className="max-w-3xl">
            ...
            >
              <span className="inline-flex items-center gap-2 px-3 py-1 rounded-sm bg-[#0F766E]/20 border border-[#0F766E]/50 text-[#2DD4BF] text-xs font-bold uppercase tracking-[0.2em] mb-8 backdrop-blur-sm">
              ...
              {/* Stats Strip */}
              <div className="mt-20 flex items-center gap-12 border-t border-slate-800 pt-8">
                <div>
                  <div className="text-3xl font-bold text-white mb-1">1.2M+</div>
                  <div className="text-xs text-slate-400 uppercase tracking-widest">Active Patients</div>
                </div>
                <div>
                  <div className="text-3xl font-bold text-white mb-1">98%</div>
                  <div className="text-xs text-slate-400 uppercase tracking-widest">Success Rate</div>
                </div>
                <div>
